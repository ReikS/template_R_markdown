---
title: "Multi-page HTML Document with analysis of table mtcars"
author: "Reik S"
date: "`r Sys.Date()`"
output:
  pagedown::html_paged:
...
This is an example of a multi-page HTML document. See https://pagedown.rbind.io for the full documentation. The rest of this document is a toy analysis of table *mtcars*.

# Analysis mtcars

```{r head_mtcars, echo=FALSE, message=TRUE, warning=FALSE}
knitr::kable(head(mtcars[, 1:5]))
```


# This is some randon text
